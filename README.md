...
<br>В данном проекте была выдвинута и проверена  гипотеза о том, что в Москве и Санкт-Петербурге пользователи слушают музыку по-разному. Данное предположение было исследованно  по данным  трёх дней недели — понедельник, среда и пятница.
